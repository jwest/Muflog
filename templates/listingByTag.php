...
<body>
	...
	<div class="pagination">
		...
		<?php if ($pagination->prev()): ?>
			<a href="<?php echo $app->config('absoluteUrl'); ?>/tag/<?php echo $tag ?>/<?php echo $pagination->prev(); ?>">&larr; Prev &lang;</a>
		<?php endif ?>

		<?php if ($pagination->next()): ?>
			<a href="<?php echo $app->config('absoluteUrl'); ?>/tag/<?php echo $tag ?>/<?php echo $pagination->next(); ?>">&rang; Next &rarr;</a>
		<?php endif ?>
