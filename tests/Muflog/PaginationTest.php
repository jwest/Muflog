...
class Muflog_Pagination_Test extends PHPUnit_Framework_TestCase {
	...
	public function testCreateInstance() {
		$this->assertInstanceOf('\Muflog\Pagination', new Pagination($this->repo->posts(), 1));
	}

	public function testGetPosts() {
		$obj = new Pagination($this->repo->posts(), 1);
	...
	public function testGetNextPage() {
		$obj = new Pagination($this->repo->posts(), 2);
